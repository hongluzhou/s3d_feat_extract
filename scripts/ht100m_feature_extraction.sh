time python main/ht100m_feature_extraction.py --n_display=1 \
       --batch_size=1 \
       ...
       --video_id_csv=/export/home/code/ginst/howto100m/ginst-HowTo100M-Feat_Extract/csv/train.csv \
       --video_path=/export/einstein-vision/multimodal_video/datasets/HowTo100M/videos \
       --caption_root=/export/home/code/ginst/howto100m/MIL-NCE_HowTo100M/data/howto100m_csv \
       --feat_save_root=/export/home/data/howto100m/debug_feats \
       --log_root=./logs \
       --log_filename=ht100m_video_feature_extraction
